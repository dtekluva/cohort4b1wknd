...
# lower_case_version = string.lower()  # RETURN LOWER CASE OF A STRING
# print(lower_case_version)

# upper_case_version = string.upper()  # RETURN LOWER CASE OF A STRING
...
# print("","".join(splitted_csv) # join a list of string with a specified delimiter)
...
# value_split= input('Enter your DOB: ')
# print(value_split.split('-'))
# splitted_value = value_split.split('-')

# year_of_age = int(splitted_value[0])
# print(year_of_age)
# age = 2021 - year_of_age
# print(age)
