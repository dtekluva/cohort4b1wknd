...
# a = int(print(input("Please  enter a value for A : ")))
# b = int(print(input("Please  enter a value for A : ")))

# if a > b:
#     print(f"{b} is larger than {b}.")
# else:
#     print(f"{a} is larger than {a}.")
    
# test for words that start with a and end with t
