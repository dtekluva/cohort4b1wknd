...
#     name_plus_salutation =  name+ '-'+ str(len(name)) 
...
# print(list(map(sqr_var,x)))    


# print(list(reversed(value_to_reversed)))
value_to_split = input('Please enter your D.O.B: ')

print(value_to_split.split('-'))
# year_of_birth = value_to_split[0]
# age = 2021 - int(year_of_birth)
# print('Am', age,  'years today')
print(value_to_split[2])